...
namespace SharpPhysics.Tests
{
    ...
    public class CollisionTests
    {
        ...
        {
            AABB a = new AABB { Min = new Vector2(0, 0), Max = new Vector2(10, 10) };
            AABB b = new AABB { Min = new Vector2(20, 20), Max = new Vector2(30, 30) };
        ...
        {
            AABB a = new AABB { Min = new Vector2(0, 0), Max = new Vector2(10, 10) };
            AABB b = new AABB { Min = new Vector2(5, 5), Max = new Vector2(15, 15) };
            bool collides = Collision.AABBvsAABB(a, b);
        ...
        public void Test_PolygonVsPolygon_Manifold_NoRotation()
        {
            ...
            AABB aabbA = new AABB { Min = new Vector2(0, 0), Max = new Vector2(10, 10) };
            AABB aabbB = new AABB { Min = new Vector2(5, 5), Max = new Vector2(15, 15) };
            ...
            Vector2 expectedContact = (A.Center + B.Center) * 0.5f;
        ...
        public void Test_CirclevsCircle_Overlap()
        {
            ...
            AABB aabbA = new AABB { Min = new Vector2(0, 0), Max = new Vector2(10, 10) };
            AABB aabbB = new AABB { Min = new Vector2(7, 7), Max = new Vector2(17, 17) };
        ...
        public void Test_BoxVsCircle_Overlap()
        {
            ...
            AABB aabbBox = new AABB { Min = new Vector2(0, 0), Max = new Vector2(20, 20) };
            AABB aabbCircle = new AABB { Min = new Vector2(15, 15), Max = new Vector2(25, 25) };
        ...
        public void Test_ResolveCollision()
        {
            ...
            AABB aabbA = new AABB { Min = new Vector2(0, 0), Max = new Vector2(10, 10) };
            AABB aabbB = new AABB { Min = new Vector2(8, 8), Max = new Vector2(18, 18) };
            ...
            A.Velocity = new Vector2(5, 0);
            B.Velocity = new Vector2(-5, 0);
            A.Angle = 0;
            B.Angle = 0;
            Manifold m = new Manifold { A = A, B = B };
            ...
            Vector2 initialAVel = A.Velocity;
            Vector2 initialBVel = B.Velocity;
        ...
        public void Test_PositionalCorrection()
        {
            ...
            m.Normal = new Vector2(1, 0);
            m.Penetration = 2;
            Vector2 initialACenter = A.Center;
            Vector2 initialBCenter = B.Center;
        ...
        public void Test_PositionalCorrection_PerpendicularBoxes()
        {
            ...
            AABB aabbA = new AABB { Min = new Vector2(0, 5), Max = new Vector2(20, 15) };

            // Box B (90°): Vertical rectangle.
            // Dimensions: width = 10, height = 20, center = (15,10) => AABB: Min=(10,0), Max=(20,20)
            AABB aabbB = new AABB { Min = new Vector2(10, 0), Max = new Vector2(20, 20) };
            ...
            boxA.Velocity = new Vector2(0, -50);
            boxB.Velocity = new Vector2(0, 50);
            ...
            Vector2 initialDiff = boxB.Center - boxA.Center;
            float initialProj = Vector2.Dot(initialDiff, m.Normal);

            // Call the positional correction.
            Collision.PositionalCorrection(ref m);

            // After correction, the centers should have moved apart along the collision normal.
            Vector2 newDiff = boxB.Center - boxA.Center;
            float newProj = Vector2.Dot(newDiff, m.Normal);
