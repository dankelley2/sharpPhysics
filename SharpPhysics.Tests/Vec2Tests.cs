...
namespace SharpPhysics.Tests
{
    ...
    public class Vector2fTests
    {
        ...
        public void DotProduct_PerpendicularVectors_ReturnsZero()
        {
            ...
            Assert.AreEqual(0, Extensions.DotProduct(v1, v2));
        }
        ...
        {
            var v1 = new Vector2f(3, 4);
            var v2 = new Vector2f(1, 2);
            var diff = v1 - v2;
